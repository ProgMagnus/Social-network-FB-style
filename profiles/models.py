...
class ProfileManager(models.Manager):
	...
	def get_all_profiles_count(self):
...
class Profile(models.Model):
	...
	avatar = models.ImageField(upload_to='profile_images/%Y/%m/%d/', default='profile_images/avatar.png', verbose_name='Изображение профиля')
	...
	def save(self, *args, **kwargs):
		...
		if self.first_name != self.__initial_first_name or self.last_name != self.__initial_last_name or self.slug=='':
			if self.first_name and self.last_name:
				to_slug = slugify(str(self.first_name)).lower() + '-' + str(self.last_name).lower()
